...
extern "C" {
    ...
    AUTOIT_EXPORTS void calcHist_Demo_draw(Mat &histImage, int histSize, int hist_w, int hist_h, Mat &b_hist, Mat &g_hist, Mat &r_hist) {
	...
	AUTOIT_EXPORTS void AKAZE_match_ratio_test_filtering(
	...
	AUTOIT_EXPORTS void AKAZE_homograpy_check(
		Mat &homography,
		vector<KeyPoint> &matched1,
