...
Func _cveBackgroundSubtractorMOG2GetHistory($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "int:cdecl", "cveBackgroundSubtractorMOG2GetHistory", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetHistory", @error)
...
Func _cveBackgroundSubtractorMOG2SetHistory($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetHistory", $bObjDllType, $obj, "int", $value), "cveBackgroundSubtractorMOG2SetHistory", @error)
...
Func _cveBackgroundSubtractorMOG2GetDetectShadows($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "boolean:cdecl", "cveBackgroundSubtractorMOG2GetDetectShadows", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetDetectShadows", @error)
...
Func _cveBackgroundSubtractorMOG2SetDetectShadows($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetDetectShadows", $bObjDllType, $obj, "boolean", $value), "cveBackgroundSubtractorMOG2SetDetectShadows", @error)
...
Func _cveBackgroundSubtractorMOG2GetShadowValue($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "int:cdecl", "cveBackgroundSubtractorMOG2GetShadowValue", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetShadowValue", @error)
...
Func _cveBackgroundSubtractorMOG2SetShadowValue($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetShadowValue", $bObjDllType, $obj, "int", $value), "cveBackgroundSubtractorMOG2SetShadowValue", @error)
...
Func _cveBackgroundSubtractorMOG2GetShadowThreshold($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveBackgroundSubtractorMOG2GetShadowThreshold", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetShadowThreshold", @error)
...
Func _cveBackgroundSubtractorMOG2SetShadowThreshold($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetShadowThreshold", $bObjDllType, $obj, "double", $value), "cveBackgroundSubtractorMOG2SetShadowThreshold", @error)
...
Func _cveBackgroundSubtractorMOG2GetNMixtures($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "int:cdecl", "cveBackgroundSubtractorMOG2GetNMixtures", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetNMixtures", @error)
...
Func _cveBackgroundSubtractorMOG2SetNMixtures($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetNMixtures", $bObjDllType, $obj, "int", $value), "cveBackgroundSubtractorMOG2SetNMixtures", @error)
...
Func _cveBackgroundSubtractorMOG2GetBackgroundRatio($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveBackgroundSubtractorMOG2GetBackgroundRatio", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetBackgroundRatio", @error)
...
Func _cveBackgroundSubtractorMOG2SetBackgroundRatio($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetBackgroundRatio", $bObjDllType, $obj, "double", $value), "cveBackgroundSubtractorMOG2SetBackgroundRatio", @error)
...
Func _cveBackgroundSubtractorMOG2GetVarThreshold($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveBackgroundSubtractorMOG2GetVarThreshold", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetVarThreshold", @error)
...
Func _cveBackgroundSubtractorMOG2SetVarThreshold($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetVarThreshold", $bObjDllType, $obj, "double", $value), "cveBackgroundSubtractorMOG2SetVarThreshold", @error)
...
Func _cveBackgroundSubtractorMOG2GetVarThresholdGen($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveBackgroundSubtractorMOG2GetVarThresholdGen", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetVarThresholdGen", @error)
...
Func _cveBackgroundSubtractorMOG2SetVarThresholdGen($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetVarThresholdGen", $bObjDllType, $obj, "double", $value), "cveBackgroundSubtractorMOG2SetVarThresholdGen", @error)
...
Func _cveBackgroundSubtractorMOG2GetVarInit($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveBackgroundSubtractorMOG2GetVarInit", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetVarInit", @error)
...
Func _cveBackgroundSubtractorMOG2SetVarInit($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetVarInit", $bObjDllType, $obj, "double", $value), "cveBackgroundSubtractorMOG2SetVarInit", @error)
...
Func _cveBackgroundSubtractorMOG2GetVarMin($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveBackgroundSubtractorMOG2GetVarMin", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetVarMin", @error)
...
Func _cveBackgroundSubtractorMOG2SetVarMin($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetVarMin", $bObjDllType, $obj, "double", $value), "cveBackgroundSubtractorMOG2SetVarMin", @error)
...
Func _cveBackgroundSubtractorMOG2GetVarMax($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveBackgroundSubtractorMOG2GetVarMax", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetVarMax", @error)
...
Func _cveBackgroundSubtractorMOG2SetVarMax($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetVarMax", $bObjDllType, $obj, "double", $value), "cveBackgroundSubtractorMOG2SetVarMax", @error)
...
Func _cveBackgroundSubtractorMOG2GetComplexityReductionThreshold($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveBackgroundSubtractorMOG2GetComplexityReductionThreshold", $bObjDllType, $obj), "cveBackgroundSubtractorMOG2GetComplexityReductionThreshold", @error)
...
Func _cveBackgroundSubtractorMOG2SetComplexityReductionThreshold($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveBackgroundSubtractorMOG2SetComplexityReductionThreshold", $bObjDllType, $obj, "double", $value), "cveBackgroundSubtractorMOG2SetComplexityReductionThreshold", @error)
