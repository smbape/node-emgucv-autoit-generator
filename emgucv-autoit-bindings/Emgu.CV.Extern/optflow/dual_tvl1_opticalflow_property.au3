...
Func _cveDualTVL1OpticalFlowGetTau($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveDualTVL1OpticalFlowGetTau", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetTau", @error)
...
Func _cveDualTVL1OpticalFlowSetTau($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetTau", $bObjDllType, $obj, "double", $value), "cveDualTVL1OpticalFlowSetTau", @error)
...
Func _cveDualTVL1OpticalFlowGetLambda($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveDualTVL1OpticalFlowGetLambda", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetLambda", @error)
...
Func _cveDualTVL1OpticalFlowSetLambda($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetLambda", $bObjDllType, $obj, "double", $value), "cveDualTVL1OpticalFlowSetLambda", @error)
...
Func _cveDualTVL1OpticalFlowGetTheta($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveDualTVL1OpticalFlowGetTheta", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetTheta", @error)
...
Func _cveDualTVL1OpticalFlowSetTheta($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetTheta", $bObjDllType, $obj, "double", $value), "cveDualTVL1OpticalFlowSetTheta", @error)
...
Func _cveDualTVL1OpticalFlowGetGamma($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveDualTVL1OpticalFlowGetGamma", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetGamma", @error)
...
Func _cveDualTVL1OpticalFlowSetGamma($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetGamma", $bObjDllType, $obj, "double", $value), "cveDualTVL1OpticalFlowSetGamma", @error)
...
Func _cveDualTVL1OpticalFlowGetScalesNumber($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "int:cdecl", "cveDualTVL1OpticalFlowGetScalesNumber", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetScalesNumber", @error)
...
Func _cveDualTVL1OpticalFlowSetScalesNumber($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetScalesNumber", $bObjDllType, $obj, "int", $value), "cveDualTVL1OpticalFlowSetScalesNumber", @error)
...
Func _cveDualTVL1OpticalFlowGetWarpingsNumber($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "int:cdecl", "cveDualTVL1OpticalFlowGetWarpingsNumber", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetWarpingsNumber", @error)
...
Func _cveDualTVL1OpticalFlowSetWarpingsNumber($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetWarpingsNumber", $bObjDllType, $obj, "int", $value), "cveDualTVL1OpticalFlowSetWarpingsNumber", @error)
...
Func _cveDualTVL1OpticalFlowGetEpsilon($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveDualTVL1OpticalFlowGetEpsilon", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetEpsilon", @error)
...
Func _cveDualTVL1OpticalFlowSetEpsilon($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetEpsilon", $bObjDllType, $obj, "double", $value), "cveDualTVL1OpticalFlowSetEpsilon", @error)
...
Func _cveDualTVL1OpticalFlowGetInnerIterations($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "int:cdecl", "cveDualTVL1OpticalFlowGetInnerIterations", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetInnerIterations", @error)
...
Func _cveDualTVL1OpticalFlowSetInnerIterations($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetInnerIterations", $bObjDllType, $obj, "int", $value), "cveDualTVL1OpticalFlowSetInnerIterations", @error)
...
Func _cveDualTVL1OpticalFlowGetOuterIterations($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "int:cdecl", "cveDualTVL1OpticalFlowGetOuterIterations", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetOuterIterations", @error)
...
Func _cveDualTVL1OpticalFlowSetOuterIterations($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetOuterIterations", $bObjDllType, $obj, "int", $value), "cveDualTVL1OpticalFlowSetOuterIterations", @error)
...
Func _cveDualTVL1OpticalFlowGetUseInitialFlow($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "boolean:cdecl", "cveDualTVL1OpticalFlowGetUseInitialFlow", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetUseInitialFlow", @error)
...
Func _cveDualTVL1OpticalFlowSetUseInitialFlow($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetUseInitialFlow", $bObjDllType, $obj, "boolean", $value), "cveDualTVL1OpticalFlowSetUseInitialFlow", @error)
...
Func _cveDualTVL1OpticalFlowGetScaleStep($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "double:cdecl", "cveDualTVL1OpticalFlowGetScaleStep", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetScaleStep", @error)
...
Func _cveDualTVL1OpticalFlowSetScaleStep($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetScaleStep", $bObjDllType, $obj, "double", $value), "cveDualTVL1OpticalFlowSetScaleStep", @error)
...
Func _cveDualTVL1OpticalFlowGetMedianFiltering($obj)
    ...
    Else
        $bObjDllType = "ptr"
    EndIf
    Return CVEDllCallResult(DllCall($_h_cvextern_dll, "int:cdecl", "cveDualTVL1OpticalFlowGetMedianFiltering", $bObjDllType, $obj), "cveDualTVL1OpticalFlowGetMedianFiltering", @error)
...
Func _cveDualTVL1OpticalFlowSetMedianFiltering($obj, $value)
    ...
    CVEDllCallResult(DllCall($_h_cvextern_dll, "none:cdecl", "cveDualTVL1OpticalFlowSetMedianFiltering", $bObjDllType, $obj, "int", $value), "cveDualTVL1OpticalFlowSetMedianFiltering", @error)
