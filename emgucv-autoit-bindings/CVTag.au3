...
Global Const $tagDMatch = _
	"int queryIdx;" & _ ; query descriptor index
	"int trainIdx;" & _ ; train descriptor index
	"int imgIdx;" & _ ; train image index
	"float distance;"

Global Const $tagCvPoint2f = $tagCvPoint2D32f

Global Const $tagKeyPoint = _
	"struct;" & $tagCvPoint2f & "endstruct;" & _ ; coordinates of the keypoints
